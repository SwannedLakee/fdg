...
echo "<div class='mt-3 ms-4 variants wordwrap'>
<h3 id='variants' class='text-center my-3 wordwrap'>Variants for ${keyword^}<div class='form-check-inline text-muted fs-4 input-group-append' data-bs-html='true' data-bs-toggle='tooltip' data-bs-placement='bottom' 
title='<strong>Variants</strong> with searched word<br><br>that are found across different editions of Pali Canon. <br><br>Abbreviation keys can be found in Edition Abbreviations section of <a href=/assets/texts/abbr.html>this page</a> or <a target=_blank href=https://suttacentral.net/abbreviations?lang=en>this</a>'>*
</div>
</h3>" >> $output/${prefix}w.html
