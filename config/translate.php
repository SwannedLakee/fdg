...
$slides = [
    [
        [
            ...
            'desc'  => 'การนำเสนอความหมายของปารมีในพระธรรมวินัยตามพระสูตร ซึ่งมีลักษณะเฉพาะแตกต่างจากความเข้าใจร่วมสมัยในบางบริบท',
            'link'  => '/en/?q=p%C4%81rami',
        ],
        [
            'title' => 'การพิจารณาธรรมในลักษณะคล้าย SWOT',
            'desc'  => 'การพิจารณาอัสสาทะ โทษ ความออก และธรรมที่ควรพิจารณา โดยใช้กรอบการใคร่ครวญเชิงวิเคราะห์',
            'link'  => '/?q=%5Cbko%5Cb.%2Aass%C4%81d.%2A%C4%81d%C4%ABnav.%2Anissara%E1%B9%87&p=-kn',
        ],
    ],
    ...
    [
        ...
        [
            'title' => 'พระตถาคตกับการประกาศสัมมาสัมโพธิญาณ',
            'desc'  => 'ข้อความในพระสูตรเกี่ยวกับช่วงเวลาก่อนที่พระตถาคตจะทรงประกาศความตรัสรู้สูงสุด เพื่อประโยชน์แก่ผู้มุ่งสู่ความหลุดพ้น',
            'link'  => '/?q=y%C4%81vak%C4%ABva%C3%B1.%2AAnuttara%E1%B9%81+samm%C4%81sambodh&p=-kn',
        ],
        [
            'title' => 'ระยะเวลาแห่งการบรรลุธรรม สำหรับบรรพชิตและคฤหัสถ์',
            'desc'  => 'พระพุทธพจน์ว่าด้วยระยะเวลาแห่งการอบรมปฏิบัติ จนถึงความก้าวหน้าในธรรม',
            'link'  => '/assets/example/(viharanto-yathaa-mayaanusi.t.tha.m-eva.m-bhaaveyya)_suttanta_pali_3-16.html',
        ],
        [
            'title' => 'ความหมายของทุกข์ในพระสูตร',
            'desc'  => 'การรวบรวมคำอธิบายเรื่อง “ทุกข์” ตามที่ปรากฏในพระสูตร เพื่อการพิจารณาเชิงคำสอน',
            'link'  => '/assets/example/kata.,-dukkha.m-question_suttanta_pali_3-3.html',
        ],
        [
            'title' => 'บุคคลประเภทต่าง ๆ ในพระธรรมวินัย',
            'desc'  => 'การจำแนกบุคคลตามพระสูตร ตั้งแต่ ๓ ประเภท ไปจนถึง ๑๐ ประเภท',
            'link'  => '/?q=Pugg.*saṁvijjam.*lokasmiṁ',
        ],
        [
            'title' => 'ความเสื่อมและความไม่เสื่อมในพระสัทธรรม',
            'desc'  => 'ตัวอย่างเหตุแห่งความเสื่อมและไม่เสื่อม ตามที่ตรัสไว้ในพระสูตร',
            'link'  => '/?q=Parihānametaṁ',
        ],
        [
            'title' => 'ยานอันประเสริฐ',
            'desc'  => 'การกล่าวถึง “ยาน” ในความหมายเชิงธรรม ตามที่ปรากฏในพระสูตร',
            'link'  => '/?q=Yānīkat',
        ],
        [
            'title' => 'ก่อนการตรัสรู้ของพระโพธิสัตว์',
            'desc'  => 'ความคิดและแนวปฏิบัติที่พระโพธิสัตว์ทรงดำเนิน ก่อนการตรัสรู้เป็นพระพุทธเจ้า',
            'link'  => '/?q=Pubb.*sambodh',
        ],
        [
            'title' => 'ชาดกในพระสูตร',
            'desc'  => 'เรื่องราวชาติปางก่อนของพระพุทธเจ้าและพระสาวก ตามที่กล่าวไว้ในพระสูตร',
            'link'  => '/?q=(bhūtapubbāha.*ahos|ahaṁ tena samayena.*ahos)',
        ],
        [
            'title' => 'ศัพท์แห่งอริยวินัย',
            'desc'  => 'คำศัพท์เฉพาะที่ใช้ในบริบทของการฝึกอบรมและความบริสุทธิ์ของอริยบุคคล',
            'link'  => '/?q=Ariyassa vinaye',
        ],
        [
            'title' => '“ท่านเห็นว่าอย่างไร”',
            'desc'  => 'พระสูตรที่มีการตั้งคำถามในลักษณะ “ท่านเห็นว่าอย่างไร” โดยพระพุทธเจ้าและพระสาวก',
            'link'  => '/assets/example/ta.m-ki.m-ma~n~n_suttanta_pali_218-610.html',
        ],
        [
            'title' => '“เราจะแสดงธรรมอันประเสริฐ”',
            'desc'  => 'พระสูตรว่าด้วยการชำระ การขจัด การดำเนินมรรค และสมาธิ',
            'link'  => '/?q=\bariy.*desessā',
        ],
        [
            'title' => 'อรรถาธิบายพระธรรม',
            'desc'  => 'ตัวอย่างคำอธิบายธรรมที่สอดคล้องกับเป้าหมายแห่งการหลุดพ้น',
            'link'  => '/?q=-la10 vuttamidaṁ',
        ],
        [
            'title' => '“ครั้นถึงกาลหนึ่ง…”',
            'desc'  => 'เหตุการณ์ที่เกิดขึ้นเป็นครั้งคราว ตามที่กล่าวไว้ในพระสูตร',
            'link'  => '/?q=Hoti kho so.*samayo',
        ],
        [
            'title' => '“เราไม่ปฏิเสธ”',
            'desc'  => 'ข้อความชี้แจงและรายละเอียดที่ปรากฏพร้อมวลีนี้ในพระสูตร',
            'link'  => '/?q=Nes.*natth.*vadāmi',
        ],
    ],
];
