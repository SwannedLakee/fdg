...
function initQuickSearchAutocomplete(inputId) {
    ...
    $.ajax({
        ...
        success: function(data) {
            var accentMap = {
                "ā": "a", "ī": "i", "ū": "u", "ḍ": "d", "ḷ": "l", "ṃ": "ṁ", "ṁ": "n", "ṁ": "m", "ṅ": "n", "ṇ": "n", "ṭ": "t", "ñ": "n", "ññ": "n", "ss": "s", "aa": "a", "ii": "i", "uu": "u", "dd": "d", "kk": "k", "ḍḍ": "d", "ḷḷ": "l", "ṇṇ": "n", "ṭṭ": "t", "cc": "c", "pp": "p", "cch": "c", "ch": "c", "kh": "k", "ph": "p", "th": "t", "ṭh": "t"
            };
            ...
            $("#" + inputId).autocomplete({
                ...
                source: function(request, response) {
                    function normalizeTerm(term) {
                        const ruToEn = {
                            'а': 'f', 'в': 'd', 'е': 't', 'к': 'r', 'м': 'v', 'н': 'y', 'о': 'j', 'п': 'g', 'р': 'h', 'с': 'c',
                            'т': 'n', 'у': 'e', 'х': '[', 'ъ': ']', 'ы': 's', 'ь': 'm', 'э': "'", 'ё': '`', 'я': 'z', 'ж': ';',
                            'з': 'p', 'и': 'b', 'й': 'q', 'л': 'k', 'д': 'l', 'г': 'u', 'ф': 'a', 'ц': 'w', 'ч': 'x', 'ш': 'i',
                            'щ': 'o', 'б': ',', 'ю': '.', ' ': ' '
                        };
                        return term.trim()
                    ...
                    var history = JSON.parse(localStorage.getItem("localSearchHistory")) || [];
                    var historyKeys = history.map(([key]) => key);
                    var filteredHistory = historyKeys.filter(key => key.toLowerCase().startsWith(lastTerm.toLowerCase()));
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            console.error("Ошибка загрузки sutta_words.txt:", textStatus, errorThrown);
        }
    });
}
...
`;
  ...
  initQuickSearchAutocomplete('quickSearchInput');
